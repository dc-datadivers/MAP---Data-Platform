...
VALUES
( 'AdventureWorks', 'DEV', 'SQL Server', 'localhost', 'AdventureWorks2019', 'DataRead', 'Localhost-Pass' ),
( 'DimDateTime', 'DEV', 'CSV', 'C:\Data', 'N/A', 'DataRead', 'Localhost-Pass' ), --assumes SHIR is running on local machine
( 'AzureAdventureWorks', 'DEV', 'Azure SQL Database', 'mmg-aue-map-sqs01-e3.database.windows.net', 'AdventureWorks', 'MI', 'MI' ), --assumes this database was created in the portal with AdventureWorks sample
( 'Canning IOT', 'PROD', 'REST', 'https://canningiot-opendata.azurewebsites.net/api', 'N/A', 'Anonymous', 'Anonymous' ), 
( 'ExcelInputs', 'DEV', 'Excel', 'C:\Data', 'N/A', 'DataRead', 'Localhost-Pass' ) --assumes SHIR is running on local machine
GO
...
(   -1 ,
    ...
    'DEV',    -- SourceEnvironment - varchar(10)
